...
int main()
{
    ...
    cout << clsUtil::GetRandomCharacter(clsUtil::CapitalLetters) << endl;
    cout << clsUtil::GenerateWord(clsUtil::MixChars, 8) << endl;
    cout << clsUtil::GenerateKey(clsUtil::MixChars) << endl;
    clsUtil::GenerateKeys(clsUtil::CapitalLetters, 10);
    ...
    //string array
    string Arr2[5] = { "Omar","Youssef","Yahya","Mariem","Khalid" };
